...
class SegNet(nn.Module):
    def init(self, input_nc, output_nc):
        super(SegNet, self).init()
        # Encoder
...
def forward(self, x):
    ...
    # Stage 5d
    x5d = F.max_unpool2d(x5p, id5, (2, 2), (2, 2))
    ...
    # Stage 4d
    x4d = F.max_unpool2d(x51d, id4, (2, 2), (2, 2))
    ...
    # Stage 3d
    x3d = F.max_unpool2d(x41d, id3, (2, 2), (2, 2))
