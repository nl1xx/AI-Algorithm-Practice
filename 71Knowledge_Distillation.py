...
# 载入训练集
train_dataset = torchvision.datasets.MNIST(root="./my_datasets", train=True, transform=transforms.ToTensor(), download=True)
test_dateset = torchvision.datasets.MNIST(root="./my_datasets", train=False, transform=transforms.ToTensor(), download=True)
