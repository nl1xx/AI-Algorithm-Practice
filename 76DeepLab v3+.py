# DeepLab v3 (xception, MobileNet2)
...
def xception(pretrained=True, downsample_factor=16):
    ...
    if pretrained:
        model.load_state_dict(load_url('https://github.com/bubbliiiing/deeplabv3-plus-pytorch/releases/download/v1.0/xception_pytorch_imagenet.pth'),
                              strict=False)
    return model
...
def mobilenetv2(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(load_url('https://github.com/bubbliiiing/deeplabv3-plus-pytorch/releases/download/v1.0/mobilenet_v2.pth.tar'),
                              strict=False)
    return model
...
class DeepLab(nn.Module):
    def __init__(self, num_classes, backbone="mobilenet", pretrained=True, downsample_factor=16):
        ...
        if backbone == "xception":
            ...
            #   主干部分    [30,30,320]
            # ----------------------------------#
            self.backbone = MobileNet_V2(downsample_factor=downsample_factor, pretrained=pretrained)
            in_channels = 320
